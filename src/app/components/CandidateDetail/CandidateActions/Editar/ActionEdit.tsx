...
export default function ActionEdit({ candidate }: ActionEditProps) {
  const t = useTranslations("CandidateDetail.CandidateActions.ActionEdit");
  ...
  const inputFields = [
    ...
    { key: "phone_number", icon: Phone, type: "tel" },
    { key: "location", icon: MapPin, type: "text" },
    { key: "age", icon: User, type: "number" },
    { key: "date_of_birth", icon: CalendarDays, type: "date" },
    { key: "current_job_title", icon: Briefcase, type: "text" },
    { key: "previous_job_title", icon: Briefcase, type: "text" },
    { key: "years_in_last_job", icon: CalendarDays, type: "number" },
    { key: "linkedin", icon: Linkedin, type: "url" },
    { key: "other_url", icon: Link, type: "url" },
    { key: "category", icon: Briefcase, type: "text" },
  ];
        ...
        <DialogContent className="min-w-[700px] max-h-[80vh] flex flex-col bg-gradient-to-br bg-white dark:from-slate-900 dark:to-slate-800 border-0 shadow-2xl">
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-1 mb-2">
              {inputFields.map(({ key, icon: Icon, type }) => (
                <div key={key} className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder={t("placeholders.input", {
                      field: t(`fields.${key}`).toLowerCase(),
                    })}
                  />
                </div>
              ))}
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div className="text-center">
                        <p className="text-sm font-medium text-slate-700 dark:text-slate-300">
                          {selectedFile ? t("selectedFile") : t("uploadNew")}
                        </p>
