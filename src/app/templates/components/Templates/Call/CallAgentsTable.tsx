...
const CallAgentsTable = (props: Props) => {
  const agents = callMock.templates;

  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="text-xl font-semibold">Call Agents</CardTitle>
      </CardHeader>
      <CardContent>
        {agents.length === 0 ? (
          <EmptyState />
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Intentos Máx.</TableHead>
